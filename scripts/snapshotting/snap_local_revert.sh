...
sudo cp -r /var/lib/ceph/osd/ceph-0.snapshot/* /var/lib/ceph/osd/ceph-0
sudo cp -r /var/lib/ceph/osd/ceph-1.snapshot/* /var/lib/ceph/osd/ceph-1
sudo cp -r /var/lib/ceph/osd/ceph-2.snapshot/* /var/lib/ceph/osd/ceph-2
