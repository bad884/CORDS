...
with open('/home/ceph-admin/CORDS/systems/ceph/testfile_8kb','r') as f:
        testfile_8kb = f.read()
        testfile_8kb = testfile_8kb.rstrip('\n')

# write to cluster
ioctx.write_full('testfile_8kb', testfile_8kb)

# check file contents
# read_data = ioctx.read("testfile_8kb")
# if read_data == testfile_8kb:
# 	print('Correct')
# else:
